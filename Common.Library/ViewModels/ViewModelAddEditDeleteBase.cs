...
namespace Common.Library
{
    public class ViewModelAddEditDeleteBase : ViewModelBase
    {
        ...
        private bool _IsRecordSelectedViewOnly;

        public bool IsRecordSelectedViewOnly
        {
            get {
                return _IsRecordSelectedViewOnly && !_IsDetailEnabled;
            }
            set
            {
                _IsRecordSelectedViewOnly = value;
                RaisePropertyChanged("IsRecordSelectedViewOnly");
